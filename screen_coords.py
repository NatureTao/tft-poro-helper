...
# 星界赐福点击位置（2个）
BLESSING_LOC = [
    Vec2(756, 600),   # 第 1 个赐福的点击坐标
    Vec2(1140, 600),   # 第 2 个赐福的点击坐标
]

# 企鹅棋子点击位置（3个）
PENGUIN_LOC = [
    Vec2(635, 1000),   # 第 1 个棋子的点击坐标
    Vec2(882, 1000),   # 第 2 个棋子的点击坐标
    Vec2(1118, 1000),   # 第 3 个棋子的点击坐标
]

# 企鹅棋子 OCR 识别区域（3个）
PENGUIN_POS = [
    Vec4(GameWindow(543, 963, 729, 999)),   # 第 1 个棋子名称的截图区域
    Vec4(GameWindow(783, 963, 969, 999)),   # 第 2 个棋子名称的截图区域
    Vec4(GameWindow(1023, 963, 1209, 999)),   # 第 3 个棋子名称的截图区域
]